...
/**
 * ClubCandidate filter form base class.
 *
 * @package    motoadicto
 * @subpackage filter
 ...
 */
abstract class BaseClubCandidateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('club_candidate_filters[%s]');
